ALLOWED_CONSTANTS= [
  ...
  :Comparable, :Enumerable, :Date, :DateTime, :String, :Symbol, :Exception, :SystemExit, :SignalException, :Interrupt, :StandardError, :TypeError,
  ...
  :TracePoint, :ARGV, :Gem, :RbConfig, :Config, :CROSS_COMPILING, :ConditionVariable, :Queue, :SizedQueue, :MonitorMixin, :Monitor,
